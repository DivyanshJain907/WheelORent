...
const Sidebar = () => {
  ...
  return (
    ...
    >
      ...
      <div className="group relative">
        <label htmlFor="image">
          <img
            ...
            alt=""
            className="h-12 md:h-18 w-12 md:w-18 rounded-full !mx-auto"
          />
          <input
            type="file"
            id="image"
          ...
          />
          <div
            className="absolute hidden top-0 left-0 bottom-0 right-0 bg-black/10 rounded-full
      ...
      {/* Owner name */}
      <p className="!mt-2 text-lg max-md:hidden">{user?.name}</p>
